...
const Header = (props) => {
    ...
    return(
        <header id='page-header' className={s.header + ' bg-primary p-0'}>
            <div className="header_inner pt-2 pl-4 pr-4">
                ...
                <div className="col-12 header__top-nav row">
                    ...
                    <div className="menu-wrapper col-sm-4 col-md-9 col-lg-9 text-right pt-1">
                        <Nav/>
                    </div>
                </div>
